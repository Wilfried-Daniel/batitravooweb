...
class ArtisanServiceWebController extends ShellController
{
    public function create(Request $request): View
    {
        ...
        return $this->render($request, 'service_form', [
            ...
            'intro' => 'Publiez une prestation artisan : visibilité marketplace après modération — comme sur l’application mobile.',
        ]);
    }
    ...
    public function edit(Request $request, Service $service): View
    {
        ...
        return $this->render($request, 'service_form', [
            ...
            'intro' => 'Mettez à jour votre offre artisan.',
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('app.artisan.services')->with('status', 'Prestation créée. Elle sera visible après validation.');
    }
    ...
    public function update(Request $request, Service $service): RedirectResponse
    {
        ...
        return redirect()->route('app.artisan.services')->with('status', 'Prestation mise à jour.');
    }
    ...
    public function destroy(Request $request, Service $service): RedirectResponse
    {
        ...
        return redirect()->route('app.artisan.services')->with('status', 'Prestation supprimée.');
    }
