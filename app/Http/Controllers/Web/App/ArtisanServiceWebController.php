...
class ArtisanServiceWebController extends ShellController
{
    public function create(Request $request): View
    {
        ...
        return $this->render($request, 'service_form', [
            ...
            'intro' => 'Publiez une prestation artisan : elle est disponible sur le marketplace dès l’enregistrement (selon la visibilité).',
        ]);
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('app.artisan.services')->with('status', 'Prestation publiée avec succès.');
    }
